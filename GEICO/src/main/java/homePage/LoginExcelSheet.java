...
public class LoginExcelSheet extends CommonAPI {
    @FindBy(id = "userName")
    ...
    public static void navigateToLoginPage(){
        TestLogger.log(LoginExcelSheet.class.getSimpleName() + ": " + convertToString(new Object(){}.getClass().getEnclosingMethod().getName()));
